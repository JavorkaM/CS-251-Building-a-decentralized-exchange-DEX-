...
const exchange_name = 'MadChange';             // TODO: fill in the name of your exchange

const token_name = 'MadToken';                // TODO: replace with name of your token
const token_symbol = 'MDT';              // TODO: replace with symbol for your token
...
const exchange_rate_nominator = 10**8;
...
async function addLiquidity(amountEth, maxSlippagePct) {
    ...
    var max_exchange_rate = (100 + Number(maxSlippagePct)) * poolState.eth_token_rate * exchange_rate_nominator / 100;
    var min_exchange_rate = (100 - Number(maxSlippagePct)) * poolState.eth_token_rate * exchange_rate_nominator / 100;
    var maxAmountToken = amountEth * max_exchange_rate;

    await token_contract.connect(provider.getSigner(defaultAccount)).approve(exchange_address,parseInt(maxAmountToken));
...
async function removeLiquidity(amountEth, maxSlippagePct) {
    ...
    await exchange_contract.connect(provider.getSigner(defaultAccount)).removeLiquidity(Number(amountEth), parseInt(max_exchange_rate), parseInt(min_exchange_rate));
...
async function swapTokensForETH(amountToken, maxSlippagePct) {
    ...
    var max_exchange_rate = (100 + Number(maxSlippagePct)) * poolState.token_eth_rate * exchange_rate_nominator / 100;
